...
\textbf{Socialization} (Tacit $\rightarrow$ Tacit): The thickest arrow. Master craftspeople develop embodied knowledge through years of sustained practice. Medieval guilds required 7–10 year apprenticeships not from tradition but from thermodynamic necessity: the time needed to build neural architectures capable of intuitive expertise \citep{delacroix2018}. This timeline reflects biological constraints---myelination, synaptic stabilization, systems memory consolidation---that we examine in detail in Section~\ref{sec:reconstruction}. Contemporary organizations replacing apprenticeships with onboarding sessions attempt to transfer decades of accumulated negentropy through PowerPoint presentations. The energy investment: years of embodied practice. The organizational allocation: typically 40–80 hours. The gap: thermodynamic impossibility.
